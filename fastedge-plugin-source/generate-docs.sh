...
#   ./fastedge-plugin-source/generate-docs.sh SDK_API.md quickstart.md # multiple files
#
...
PACKAGE_NAME="@gcoredev/proxy-wasm-sdk-as"
...
PROMPT
  ...
  while [ $attempt -le $max_attempts ]; do
    ...
    # this limit as the SDK grows; stdin has no such cap.
